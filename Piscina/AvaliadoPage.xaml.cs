...
public partial class AvaliadoPage : ContentPage
{
    ...
    public AvaliadoPage(object recebido)
    {
        ...
        Objetivo ob1 = new Objetivo("Dominio da Respiracao(inspiração/expiração) automatizado", 3);
        List<Objetivo> l1 = new List<Objetivo> { ob1 };
        Categoria c1 = new Categoria("Respiração", l1);

        Objetivo ob2 = new Objetivo("Tem um correto alinhamento lateral e horizontal nas diversas ações motoras. Posição Hidrodinâmica Fundamental", 3);
        List<Objetivo> l2 = new List<Objetivo> { ob2 };
        Categoria c2 = new Categoria("Alinhamento", l2);

        Objetivo ob3 = new Objetivo("Executa batimento de pernas dorsal associado ao movimento alternado de braços/inspiração", 3);
        ...
        Objetivo ob6 = new Objetivo("Execução de movimentos propulsivos de pernas e braços continuo( nado continuo)", 2);
        ...
        Objetivo ob8 = new Objetivo("Entrada correta dos membros superiores coordenado com respiração bilateral", 3);
        Objetivo ob9 = new Objetivo("Executa corretamente a pernada", 2);
        Objetivo ob10 = new Objetivo("Execução de movimentos propulsivos de pernas e braços continuo( nado continuo)", 2);
        List<Objetivo> l4 = new List<Objetivo> { ob7, ob8, ob9, ob10 };
        Categoria c4 = new Categoria("Crol", l4);

        Objetivo ob11 = new Objetivo("Da parede, com deslize, com batimento dos pés,de cabeça (inicio do ensino da partida de Crol)", 3);
        List<Objetivo> l5 = new List<Objetivo> { ob11 };
        Categoria c5 = new Categoria("Saltos", l5);

        Objetivo ob12 = new Objetivo("Não corre no cais da piscina, toma banho antes de entrar, arruma o seu material, brinca com segurança", 3);
        List<Objetivo> l6 = new List<Objetivo> { ob12 };
        Categoria c6 = new Categoria("Segurança e higiene", l6);

        Objetivo ob13 = new Objetivo("Espirito de sociabilização e desportivo. Respeita as regras da aula, os colegas e o Professor. É participante na aula", 3);
